...
// c_nmf2
Rcpp::List c_nmf2(const Eigen::SparseMatrix<double> A, const double tol, const uint16_t maxit, const bool verbose, const double L1, const int threads, Eigen::MatrixXd w);
RcppExport SEXP _FastNMF_c_nmf2(SEXP ASEXP, SEXP tolSEXP, SEXP maxitSEXP, SEXP verboseSEXP, SEXP L1SEXP, SEXP threadsSEXP, SEXP wSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::SparseMatrix<double> >::type A(ASEXP);
    ...
    Rcpp::traits::input_parameter< const int >::type threads(threadsSEXP);
    Rcpp::traits::input_parameter< Eigen::MatrixXd >::type w(wSEXP);
    rcpp_result_gen = Rcpp::wrap(c_nmf2(A, tol, maxit, verbose, L1, threads, w));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_FastNMF_c_nmf2", (DL_FUNC) &_FastNMF_c_nmf2, 7},
    {NULL, NULL, 0}
};
